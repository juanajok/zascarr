...
- **SecuenciArr no controla ni audita** las fuentes que el usuario configure; esa elección es responsabilidad exclusiva del usuario.
...
Implicaciones para SecuenciArr:
...
Al usar SecuenciArr, el usuario acepta que:
...
El código fuente de SecuenciArr se distribuye bajo la licencia **GNU General Public License v3.0** (GPL-3.0) [web:157].
...
Algunas fuentes de metadatos usadas por SecuenciArr tienen licencias propias:
...
**SecuenciArr no redistribuye** contenido de estas fuentes. Todo metadato o portada se cachea localmente para el uso privado del usuario final.
...
- **Asunto:** Notificación de propiedad intelectual — SecuenciArr
